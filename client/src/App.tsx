  ...
  return (
    <Layout>
      ...
      <Switch>
        ...
        {/* Drinks branches */}
        <Route path="/drinks/smoothies/:rest*">{() => <DrinksSection />}</Route>
        <Route path="/drinks/protein-shakes/:rest*">
          {() => <DrinksSection />}
        </Route>
        <Route path="/drinks/detoxes/:rest*">{() => <DrinksSection />}</Route>
        <Route path="/drinks/caffeinated/:rest*">{() => <DrinksSection />}</Route>
        <Route path="/drinks/potent-potables/:rest*">
          {() => <DrinksSection />}
        </Route>
