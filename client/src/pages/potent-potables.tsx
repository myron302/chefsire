...
export default function PotentPotables() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      ...
      <Button onClick={() => setShowForm(true)} className="mt-4 bg-blue-700 text-white hover:bg-opacity-90">
        Add New Drink
      </Button>
        ...
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded shadow-lg w-1/3">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-blue-700">Drink Name</label>
                <Input
                  type="text"
                  value={newDrink.name}
              ...
              <div>
                <label className="block text-sm font-medium text-blue-700">Ingredients</label>
                <Input
                  type="text"
              ...
              <div className="flex justify-end space-x-2">
                ...
                <Button type="submit" className="bg-blue-700 text-white hover:bg-opacity-90">
                  Submit
                </Button>
              </div>
            </form>
