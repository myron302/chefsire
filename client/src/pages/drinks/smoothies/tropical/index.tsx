...
const tropicalAdvantages = [
  { icon: Sun, title: 'Vitamin C Power', description: 'Rich in immune-boosting vitamins', color: 'text-purple-600' },
  { icon: Palmtree, title: 'Natural Energy', description: 'Sustained energy from tropical fruits', color: 'text-purple-600' },
  { icon: Heart, title: 'Heart Health', description: 'Supports cardiovascular function', color: 'text-purple-600' },
  { icon: Sparkles, title: 'Hydration', description: 'Natural electrolytes and hydration', color: 'text-purple-600' },
  { icon: Leaf, title: 'Digestive Enzymes', description: 'Improves digestion naturally', color: 'text-purple-600' },
  { icon: Zap, title: 'Mood Boost', description: 'Tropical flavors elevate mood', color: 'text-purple-600' }
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <Card className="mb-8">
          <CardContent className="p-6">
            <h2 className="text-2xl font-bold mb-6 flex items-center gap-2">
              <Palmtree className="h-6 w-6 text-purple-500" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-indigo-600">{tropicalSmoothies.length}</div>
        ...
        {activeTab === 'browse' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              const canonicalSlug = resolveCanonicalDrinkSlug({ slug: smoothie.slug, name: smoothie.name, sourceRoute: '/drinks/smoothies/tropical' });
                  ...
                  <Card key={smoothie.id} onClick={(e) => { e.stopPropagation(); openRecipeModal(smoothie); }} className="hover:shadow-lg transition-shadow cursor-pointer">
                    ...
                    <CardContent>
                      ...
                      <div className="grid grid-cols-3 gap-2 mb-4 text-center text-sm">
                        ...
                        <div>
                          <div className="font-bold text-blue-600">{smoothie.prepTime}m</div>
              ...
              <Card key={flavor.id} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <div className="text-center bg-purple-50 p-3 rounded-lg mb-4">
                    ...
                    <div className="text-lg font-bold text-purple-600">Island Paradise</div>
                  </div>
