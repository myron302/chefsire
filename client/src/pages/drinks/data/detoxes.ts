...
export const detoxSubcategories: DetoxSubcategory[] = [
  {
    ...
    icon: Apple,
    image: 'https://placehold.co/600x400/fb923c/white?text=Detox+Juices',
  ...
  },
  {
    ...
    icon: Coffee,
    image: 'https://placehold.co/600x400/16a34a/white?text=Detox+Teas',
  ...
  },
  {
    ...
    icon: Droplets,
    image: 'https://placehold.co/600x400/2563eb/white?text=Infused+Waters',
