...
import {
  ...
  campaignGoalLabel,
  campaignHealthBadgeVariant,
  campaignHealthLabel,
  describeState,
  formatHealthDateTime,
  formatMilestoneDate,
  formatTimingDelay,
  rolloutAdviceTypeLabel,
  rolloutAudienceLabel,
  rolloutModeLabel,
  rolloutStateLabel,
  timingAdviceTypeLabel,
} from "@/pages/drinks/campaign-detail/utils";
import {
  type CampaignDetailResponse,
  type CampaignGoalItem,
  type CampaignHealthItem,
  type CampaignPlaybookOnboardingResponse,
} from "@/pages/drinks/campaign-detail/types";
            ...
            actions={(
              <>
                <CampaignFollowButton
                  ...
                  variant={hasPrimaryOffer ? "outline" : (campaign?.isFollowing ? "outline" : "default")}
                ...
                <div className="flex flex-wrap gap-2">
                  {activeVariant.ctaTargetType === "follow" ? (
                    <CampaignFollowButton
                      ...
                      creatorUserId={campaign?.creatorUserId}
                      size="default"
                      variant={hasPrimaryOffer ? "outline" : undefined}
