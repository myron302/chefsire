...
import { 
  ...
  Clipboard, RotateCcw, Check, BookOpen, Home, Droplets, Cherry, Coffee} from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {activeTab === 'browse' && (
            <div>
              ...
              const canonicalSlug = resolveCanonicalDrinkSlug({ slug: cocktail.slug, name: cocktail.name, sourceRoute: '/drinks/potent-potables/cognac-brandy' });
