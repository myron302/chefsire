...
const classicCocktails = [
  {
    ...
    instructions: 'Muddle sugar cube with bitters. Add whiskey and ice. Stir until chilled. Express orange peel over drink.',
  ...
  },
  {
    ...
    instructions: 'Stir gin and vermouth with ice until very cold. Strain into chilled martini glass. Garnish.',
...
export default function ClassicCocktailsPage() {
  ...
  const getFilteredCocktails = () => {
    ...
    filtered.sort((a, b) => {
      switch (sortBy) {
        ...
        case 'era': return cocktail.era.localeCompare(cocktail.era);
        case 'difficulty': 
  ...
  const handleMakeCocktail = (cocktail: any) => {
    addToRecentlyViewed({
      id: cocktail.id,
      name: cocktail.name,
    ...
    console.log(`Made ${cocktail.name}! +40 XP`);
  };
                  ...
                  <Card key={cocktail.id} className="hover:shadow-lg transition-shadow">
                    <CardHeader className="pb-2">
                      <div className="flex items-start justify-between">
                        ...
                        <Button
                          ...
                          onClick={() => addToFavorites({
                            ...
                            description: cocktail.description,
                            ingredients: cocktail.ingredients,
                            nutrition: { calories: 150, protein: 0, carbs: 8, fat: 0 },
                            difficulty: cocktail.difficulty,
                            prepTime: cocktail.prepTime,
                            rating: cocktail.rating,
                            fitnessGoal: 'Social',
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Badge className="bg-amber-100 text-amber-800">{cocktail.category}</Badge>
                ...
                <Card key={cocktail.id} className="overflow-hidden hover:shadow-xl transition-shadow">
                  <div className="relative">
                    ...
                    <div className="absolute top-4 left-4">
                      <Badge className="bg-yellow-500 text-white">Featured Classic</Badge>
                    </div>
                  </div>
                  ...
                  <CardContent>
                    ...
                    <div className="bg-amber-50 p-4 rounded-lg mb-6">
                      <h4 className="font-medium text-amber-900 mb-2">Historical Note:</h4>
                      <p className="text-sm text-amber-800">{cocktail.history}</p>
                    </div>

                    {/* Enhanced details display */}
                    <div className="grid grid-cols-4 gap-4 mb-6 p-4 bg-gray-50 rounded-lg">
                      <div className="text-center">
                        <div className="text-xl font-bold text-amber-600">{cocktail.abv}</div>
                        <div className="text-xs text-gray-600">ABV</div>
                      </div>
                      <div className="text-center">
                        <div className="text-xl font-bold text-blue-600">{cocktail.prepTime}min</div>
                      ...
                      <div className="text-center">
                        <div className="text-xl font-bold text-green-600">{cocktail.difficulty}</div>
          ...
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-6 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-amber-600">{filteredCocktails.length}</span>
              </div>
              <div className="flex items-center gap-2">
