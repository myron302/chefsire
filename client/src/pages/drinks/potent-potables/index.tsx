...
import { getDrinkCategoryHeroVisual, POTENT_POTABLES_CATEGORY_ASSET_PATHS } from '@/constants/drink-images';
...
const potentPotablesSubcategories = [
  ...
  },
  {
    ...
    image: getDrinkCategoryHeroVisual('/drinks/potent-potables/daiquiri').image,
    fallbackImage: getDrinkCategoryHeroVisual('/drinks/potent-potables/daiquiri').fallbackImage,
    bgColor: 'bg-cyan-50',
    borderColor: 'border-cyan-200',
    textColor: 'text-cyan-600',
    avgCalories: 160,
  ...
  },
  {
    ...
    image: getDrinkCategoryHeroVisual('/drinks/potent-potables/martinis').image,
    fallbackImage: getDrinkCategoryHeroVisual('/drinks/potent-potables/martinis').fallbackImage,
  ...
  },
  {
    ...
    image: getDrinkCategoryHeroVisual('/drinks/potent-potables/scotch-irish-whiskey').image,
    fallbackImage: getDrinkCategoryHeroVisual('/drinks/potent-potables/scotch-irish-whiskey').fallbackImage,
  ...
  },
  {
    ...
    image: getDrinkCategoryHeroVisual('/drinks/potent-potables/spritz').image,
    fallbackImage: getDrinkCategoryHeroVisual('/drinks/potent-potables/spritz').fallbackImage,
    bgColor: 'bg-yellow-50',
    borderColor: 'border-yellow-200',
    textColor: 'text-yellow-600',
    trending: true,
  ...
  },
  {
    ...
    image: getDrinkCategoryHeroVisual('/drinks/potent-potables/hot-drinks').image,
    fallbackImage: getDrinkCategoryHeroVisual('/drinks/potent-potables/hot-drinks').fallbackImage,
    bgColor: 'bg-red-50',
    borderColor: 'border-red-200',
    textColor: 'text-red-600',
    avgCalories: 230,
  ...
  },
  {
    ...
    image: getDrinkCategoryHeroVisual('/drinks/potent-potables/cocktails').image,
    fallbackImage: getDrinkCategoryHeroVisual('/drinks/potent-potables/cocktails').fallbackImage,
  ...
  },
  {
    ...
    image: getDrinkCategoryHeroVisual('/drinks/potent-potables/seasonal').image,
    fallbackImage: getDrinkCategoryHeroVisual('/drinks/potent-potables/seasonal').fallbackImage,
    bgColor: 'bg-teal-50',
    borderColor: 'border-teal-200',
    textColor: 'text-teal-600',
    avgCalories: 175,
  ...
  },
  {
    ...
    image: getDrinkCategoryHeroVisual('/drinks/potent-potables/mocktails').image,
    fallbackImage: getDrinkCategoryHeroVisual('/drinks/potent-potables/mocktails').fallbackImage,
  ...
  },
  {
    ...
    image: getDrinkCategoryHeroVisual('/drinks/potent-potables/virgin-cocktails').image,
    fallbackImage: getDrinkCategoryHeroVisual('/drinks/potent-potables/virgin-cocktails').fallbackImage,
    bgColor: 'bg-sky-50',
