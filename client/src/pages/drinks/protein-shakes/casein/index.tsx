...
export default function CaseinProteinPage() {
  const sisters = PROTEIN_SISTERS.filter(s => s.id !== "casein");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-3xl font-bold text-gray-900">Casein Protein Shakes</h1>
              <Badge className="bg-orange-100 text-orange-800">Overnight</Badge>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[
          { id: "c1", title: "Vanilla Night-Cap", emoji: "🌙" },
          { id: "c2", title: "Cinnamon Oat Slow-Release", emoji: "🧂" },
          { id: "c3", title: "Chocolate Dream", emoji: "🍫" },
        ].map((f) => (
          <Card key={f.id} className="hover:shadow-lg transition">
            ...
            <CardContent className="flex items-center justify-between">
              <Badge variant="outline">Casein</Badge>
              <Link href="/drinks">
                <Button variant="outline" size="sm">Explore Drinks</Button>
              </Link>
            </CardContent>
          </Card>
        ))}
