...
export default function EggProteinPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-amber-100">
      ...
      <div className="bg-gradient-to-r from-amber-600 via-yellow-600 to-orange-600 text-white py-12 px-6 rounded-xl shadow-2xl">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-2">Egg Protein Shakes</h1>
              <p className="text-xl text-amber-100">Complete amino acid profile with the highest biological value</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Card className="bg-white/10 backdrop-blur border-white/20 hover:bg-white/20 transition-all">
              <CardContent className="p-4 text-center">
                <Target className="h-8 w-8 mx-auto mb-2 text-amber-300" />
            ...
            <Card className="bg-white/10 backdrop-blur border-white/20 hover:bg-white/20 transition-all">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-sm text-amber-100">Avg Protein</div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/10 backdrop-blur border-white/20 hover:bg-white/20 transition-all">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-sm text-amber-100">{userProgress.totalPoints} XP</div>
              </CardContent>
            </Card>

            <Card className="bg-white/10 backdrop-blur border-white/20 hover:bg-white/20 transition-all">
              <CardContent className="p-4 text-center">
                <CheckCircle className="h-8 w-8 mx-auto mb-2 text-orange-300" />
                <div className="text-2xl font-bold">{userProgress.totalDrinksMade}</div>
                <div className="text-sm text-amber-100">Shakes Made</div>
              </CardContent>
            </Card>
          </div>
        </div>
