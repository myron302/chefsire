...
import { Coffee, Clock, Heart, Star, Search, Share2, ArrowLeft, Camera, Zap, X, Check, Clipboard, RotateCcw, Sparkles, Wine, Flame, Target, Leaf, Palmtree, Droplets, Sun, Crown } from 'lucide-react';
