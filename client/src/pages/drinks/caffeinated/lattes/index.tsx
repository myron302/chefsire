// client/src/pages/drinks/caffeinated/lattes/index.tsx
...
const parseIngredient = (ingredient: string): Measured => {
  ...
  const descriptors = new Set(['cold', 'latte', 'fresh', 'brewed', 'strong', 'double', 'vanilla', 'chocolate']);
...
// Sister caffeinated subcategories (excluding latte since we're on latte page)
const allCaffeinatedSubcategories = [
  ...
  { id: 'cold-brew', name: 'Cold Brew', path: '/drinks/caffeinated/cold-brew', icon: Coffees, description: 'Smooth cold coffee' },
...
export default function LattesPage() {
  ...
  const handleSharePage = async () => {
    const shareData = {
      title: 'Latte Drinks',
      text: `Browse ${latteDrinks.length} latte drinks for refreshing energy.`,
        ...
        <Card className="mb-8">
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {latteAdvantages.map((advantage, index) => {
              ...
              <CardContent className="p-4">
                <div className="flex flex-col md:flex-row gap-4">
                  <div className="flex-1 relative">
                    ...
                    <Input
                      placeholder="Search latte drinks..."
                      value={searchQuery}
