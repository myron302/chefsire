...
const parseIngredient = (ingredient: string): Measured => {
  ...
  const descriptors = new Set(['cold', 'energy', 'fresh', 'brewed', 'strong', 'double', 'vanilla', 'chocolate']);
...
const energyAdvantages = [
  { icon: Zap, title: 'Refreshingly Cold', description: 'Perfect cool coffee experience', color: 'text-orange-400' },
  { icon: Clock, title: 'Quick Prep', description: 'Ready in 2-4 minutes', color: 'text-orange-400' },
  { icon: Zap, title: 'Energy Boost', description: 'Caffeine when you need it', color: 'text-orange-400' },
  { icon: Star, title: 'Versatile', description: 'Endless flavor combinations', color: 'text-orange-400' },
  { icon: Sun, title: 'Anytime Drink', description: 'Perfect for any time of day', color: 'text-orange-400' },
  { icon: Heart, title: 'Customizable', description: 'Make it exactly how you like', color: 'text-orange-400' }
];
...
export default function EnergyPage() {
  ...
  const handleSharePage = async () => {
    const shareData = {
      title: 'Energy Drinks',
      text: `Browse ${energyDrinks.length} energy drink drinks for refreshing energy.`,
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-2xl font-bold text-gray-900">Energy Drinks</h1>
                <Badge className="bg-orange-100 text-orange-600 border-orange-200">High-Energy</Badge>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <Button size="sm" className="bg-orange-400 hover:bg-orange-500 text-white" onClick={handleSharePage}>
                ...
                return (
                  <Link key={hub.id} href={hub.route}>
                    <Button variant="outline" className="w-full justify-start hover:bg-orange-50 hover:border-orange-300">
                      <Icon className="h-4 w-4 mr-2 text-orange-400" />
        ...
        <Card className="mb-8">
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {energyAdvantages.map((advantage, index) => {
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-orange-400">149</div>
              <div className="text-sm text-gray-600">Avg Calories</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-orange-400">4.4g</div>
          ...
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-orange-400">{energyDrinks.length}</div>
        ...
        {activeTab === 'browse' && (
          <div className="space-y-6">
              ...
              <CardContent className="p-4">
                <div className="flex flex-col md:flex-row gap-4">
                  <div className="flex-1 relative">
                    ...
                    <Input
                      placeholder="Search energy drink drinks..."
                      value={searchQuery}
                  ...
                  <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-2">
                    ...
                    >
                      ...
                      {energyBenefitsList.map(benefit => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              const canonicalSlug = resolveCanonicalDrinkSlug({ slug: drink.slug, name: drink.name, sourceRoute: '/drinks/caffeinated/energy' });
                ...
                return (
                  <Card key={drink.id} onClick={(e) => { e.stopPropagation(); openRecipeModal(drink); }} className="hover:shadow-lg transition-shadow cursor-pointer">
                    <CardHeader className="pb-2">
                      ...
                      <div className="flex items-center gap-2">
                        <Badge className="bg-orange-100 text-orange-600 border-orange-200">{drink.drinkType}</Badge>
                    ...
                    <CardContent>
                      ...
                      <div className="grid grid-cols-3 gap-2 mb-4 text-center text-sm">
                        <div>
                          <div className="font-bold text-orange-400">{drink.nutrition.calories}</div>
                          <div className="text-gray-500">Calories</div>
                        </div>
                        <div>
                          <div className="font-bold text-orange-400">{drink.nutrition.protein}g</div>
                          <div className="text-gray-500">Protein</div>
                        </div>
                        <div>
                          <div className="font-bold text-orange-400">{drink.prepTime}m</div>
                      ...
                      <div className="space-y-2 mb-3 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-orange-400">{drink.bestTime}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-1 mb-4">
                        {drink.benefits?.slice(0, 3).map((benefit: string, index: number) => (
                          <Badge key={index} variant="secondary" className="text-xs bg-orange-100 text-orange-600 hover:bg-orange-200">
                            {benefit}
                          </Badge>
                        ))}
                      </div>
                ...
                <Card key={type.id} className="hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <div className="text-center bg-orange-50 p-3 rounded-lg mb-4">
                      ...
                      <div className="text-lg font-bold text-orange-400">{type.timing}</div>
                    </div>
              ...
              <Card key={benefit.id} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <div className="text-center bg-orange-50 p-3 rounded-lg mb-4">
                    ...
                    <div className="text-lg font-bold text-orange-400">Energy Support</div>
                  </div>
                  <Button className="w-full bg-orange-400 hover:bg-orange-500 text-white" onClick={() => setActiveTab('browse')}>
                    View {benefit.name}
                  </Button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {featuredDrinks.map(drink => (
              <Card key={drink.id} className="overflow-hidden hover:shadow-xl transition-shadow">
                <div className="relative h-48 bg-gradient-to-br from-orange-100 to-red-200 flex items-center justify-center">
                  <Zap className="h-24 w-24 text-orange-400 opacity-50" />
                  <Badge className="absolute top-4 left-4 bg-orange-400 text-white">Featured</Badge>
                </div>
