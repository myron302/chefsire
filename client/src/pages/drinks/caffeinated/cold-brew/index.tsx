...
import { coldBrewDrinks } from '@/data/drinks/caffeinated/cold-brew';
        ...
        {activeTab === 'browse' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              const canonicalSlug = resolveCanonicalDrinkSlug({ slug: drink.slug, name: drink.name, sourceRoute: '/drinks/caffeinated/cold-brew' });
