...
export default function ColdBrewDrinks() {
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-8">
        ...
        <div className="bg-gradient-to-r from-amber-600 via-orange-600 to-brown-600 text-white py-12 px-6 rounded-xl shadow-2xl">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-2">Cold Brew Coffee</h1>
              <p className="text-xl text-amber-100">Smooth, refreshing cold-brewed perfection</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Card className="bg-white/10 backdrop-blur border-white/20">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-2xl font-bold">{coldBrewDrinks.length}</div>
            ...
            <Card className="bg-white/10 backdrop-blur border-white/20">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-2xl font-bold">200mg</div>
