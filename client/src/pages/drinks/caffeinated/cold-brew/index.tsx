...
const coldBrewDrinks = [
  {
    ...
    ingredients: ["8 oz cold brew concentrate", "8 oz filtered water", "1 cup ice"],
  ...
  },
  {
    ...
    ingredients: ["8 oz cold brew concentrate", "4 oz filtered water", "2 oz vanilla sweet cream", "1 cup ice"],
  ...
  },
  {
    ...
    ingredients: ["12 oz nitro cold brew", "Nitrogen infusion"],
  ...
  },
  {
    ...
    ingredients: ["8 oz cold brew concentrate", "4 oz milk", "2 tbsp caramel syrup", "1 pinch sea salt", "1 cup ice"],
  ...
  },
  {
    ...
    ingredients: ["8 oz cold brew concentrate", "4 oz milk", "2 tbsp chocolate syrup", "1 cup ice"],
  ...
  },
  {
    ...
    ingredients: ["8 oz cold brew concentrate", "4 oz almond milk", "1 scoop vanilla protein powder", "1 cup ice"],
  ...
  },
  {
    ...
    ingredients: ["8 oz cold brew concentrate", "6 oz oat milk", "1 cup ice"],
  ...
  },
  {
    ...
    ingredients: ["8 oz cold brew concentrate", "4 oz filtered water", "2 oz coconut cream", "1 cup ice"],
    ...
    return coldBrewDrinks.map((d) => {
      ...
      return {
        ...
        recipe: {
          servings: 1,
          measurements,
          directions: ["Fill glass with ice", "Pour cold brew concentrate", "Add milk or water as needed", "Stir gently and enjoy"],
        },
      };
    });
  }, []);
  ...
  const getFilteredDrinks = () => {
    let filtered = drinkRecipesWithMeasurements.filter((drink) => {
      ...
      const matchesBenefit =
        !selectedBenefit || drink.benefits.some((b: string) => b.toLowerCase().includes(selectedBenefit.toLowerCase()));
                    ...
                    <CardHeader className="pb-2">
                      <div className="flex items-start justify-between">
                        ...
                        >
                          <Heart
                            className={`h-4 w-4 ${
                              isFavorite(drink.id) ? "fill-red-500 text-red-500" : "text-gray-400"
                            }`}
                          />
                        </Button>
                      </div>
