...
export default function Feed() {
  ...
  // FORCE demo data to show new images (remove this later when you want to use real API data)
  const displaySuggestedUsers = demoSuggestedUsers;
  const displayTrendingRecipes = demoTrendingRecipes;
