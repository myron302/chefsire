...
import {
  ...
  BookOpen,
  User,
  Plus,import { useMemo, useState } from "react";
import { Link, useLocation } from "wouter";
...
const NAV: NavItem[] = [
  ...
  { name: "🗺️ BiteMap", href: "/bitemap", icon: Map },

  // ✅ Competitions - with emoji icons
  {
    name: "🏆 Cookoff Arena",
    href: "/competitions",
    icon: Trophy,
    ...
    submenu: [
      ...
      { name: "⚔️ Live Battles", href: "/competitions?status=live", icon: Swords },
    ...
    submenu: [
      { name: "🥤 Drinks Hub", href: "/drinks", icon: GlassWater },
      {
        ...
        submenu: [
          ...
          { name: "🏋️ Workout", href: "/drinks/smoothies/workout", icon: Activity },
        ],
      },
      {
        name: "🧪 Protein Shakes",
      ...
      },
      {
        ...
        submenu: [
          ...
          { name: "🏝️ Rum", href: "/drinks/potent-potables/rum", icon: Wine },
