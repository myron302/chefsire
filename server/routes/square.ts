...
import { subscriptionCheckoutRequestSchema, subscriptionCheckoutUnavailableResponse } from "../lib/subscription-security";

const router = Router();

/**
 * POST /api/square/subscription-link
 * Body: { tier: canonical paid marketplace tier, trial?: boolean }
 *
