...
import { availabilityExceptionSchema, availabilitySettingsSchema, calendarDateSchema, formatCateringCalendarDate, weeklyRulesSchema } from "./catering-availability";
...
test("persisted inquiry days format independently of viewer timezone", () => {
  for (const _viewerTimezone of ["UTC", "Etc/GMT+8", "Pacific/Auckland", "Pacific/Kiritimati", "Asia/Tokyo"]) assert.equal(formatCateringCalendarDate("2026-08-27T12:00:00.000Z"), "Aug 27, 2026");
  assert.equal(formatCateringCalendarDate("2026-09-01T12:00:00.000Z"), "Sep 1, 2026");
  assert.equal(formatCateringCalendarDate("2027-01-01T12:00:00.000Z"), "Jan 1, 2027");
  assert.equal(formatCateringCalendarDate("2028-02-29T12:00:00.000Z"), "Feb 29, 2028");
});
